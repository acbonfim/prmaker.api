...
VALUES (1, '88038803-fab9-41c9-9132-2984b083d647', '3ae55e1d-1dcd-4b35-953c-9fb2188232fa', 'admin', 'ADMIN'),
       ...
       (3, '424120d7-2aae-4023-9db0-bdb41ad9747f', '8de8ae78-bc76-4583-9d19-89ea986d5544', 'external_client',
        'EXTERNALCLIENT');
...
ALTER TABLE `AspNetUsers`
    ADD `ChannelOrigin` longtext CHARACTER SET utf8mb4 NOT NULL;

UPDATE `AspNetRoles`
SET `ConcurrencyStamp` = '8DD68F0C-5AA5-40E4-AE26-C93166E4A1C9',
    `ExternalId`       = '82904b6d-bf05-4d2a-a98f-6c665a6a02a4'
WHERE `Id` = 1;
SELECT ROW_COUNT();


UPDATE `AspNetRoles`
SET `ConcurrencyStamp` = 'D3AE6011-BA86-4923-A987-76FAD446C46A',
    `ExternalId`       = 'abeb985b-1640-466c-a581-5cf170342827'
WHERE `Id` = 2;
SELECT ROW_COUNT();


UPDATE `AspNetRoles`
SET `ConcurrencyStamp` = '8D28F93A-1771-47A9-9657-22798B4FA74C',
    `ExternalId`       = 'c48b559b-db3b-4ec8-a06f-4f5e055c5210'
WHERE `Id` = 3;
SELECT ROW_COUNT();
...
UPDATE `AspNetRoles`
SET `ConcurrencyStamp` = '45F2E010-33EB-4692-8BE7-C042D3CDEB25',
    `ExternalId`       = '11b0bdb7-ccd7-4811-8aa8-93d9a92ebc0b',
    `Level`            = 0
WHERE `Id` = 1;
SELECT ROW_COUNT();
...
UPDATE `AspNetRoles`
SET `ConcurrencyStamp` = 'A160DCA9-5F62-42C2-B03C-9AF6728E2C8B',
    `ExternalId`       = '3de81c66-ae8f-4205-b5cd-eb1485e020a0',
    `Level`            = 0
WHERE `Id` = 2;
SELECT ROW_COUNT();
...
UPDATE `AspNetRoles`
SET `ConcurrencyStamp` = '81997F5A-CB20-4576-9E7B-3F769E69ED99',
    `ExternalId`       = 'a542e938-55a9-4463-b288-8d45c44fac1f',
    `Level`            = 0
WHERE `Id` = 3;
SELECT ROW_COUNT();
