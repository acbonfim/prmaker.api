...
public interface IVacationApplication
{
    ...
    Task<List<VacationRequestResponse>> GetAllVacationRequestsAsync(CancellationToken cancellationToken);
    ...
    Task<List<CalendarDayResponse>> GetCalendarAsync(int month, int year, CancellationToken cancellationToken);
